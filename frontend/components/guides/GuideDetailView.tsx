...
import { BadgeCheck, MapPin, Star, Award, User } from 'lucide-react'
    ...
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-4 pb-36">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        {g.specialties && g.specialties.length > 0 ? (
          <div>
            <h2 className="mb-1 text-sm font-semibold text-foreground">{t('detail.specialties')}</h2>
            <div className="flex flex-wrap gap-1.5">
              {g.specialties.map((s) => (
